...
CREATE TABLE "posts" (
    ...
    "author" TEXT NOT NULL DEFAULT 'zsden',
...
-- AddForeignKey
ALTER TABLE "view_logs" ADD CONSTRAINT "view_logs_postId_fkey" FOREIGN KEY ("postId") REFERENCES "posts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
